package kosii.test.crud.comtnbbs.service.impl;
...
public class ComtnbbsDAO extends EgovComAbstractDAO {

	/**
	 * COMTNBBS을 등록한다.
	 * 
	 * @param vo
	 *            - 등록할 정보가 담긴 ComtnbbsVO
	 * @return 등록 결과
	 * @exception Exception
	 */
	 ...
	 * @exception Exception
	 */
	public List<?> selectComtnbbsList(ComtnbbsDefaultVO searchVO)
			throws Exception {
	...
	public int selectComtnbbsListTotCnt(ComtnbbsDefaultVO searchVO) {
		return (Integer) select("comtnbbsDAO.selectComtnbbsListTotCnt_S",
				searchVO);
	}
