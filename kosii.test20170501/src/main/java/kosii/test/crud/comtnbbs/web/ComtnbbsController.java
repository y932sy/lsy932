package kosii.test.crud.comtnbbs.web;

import java.util.List;

import javax.annotation.Resource;

import kosii.test.crud.comtnbbs.service.ComtnbbsDefaultVO;
import kosii.test.crud.comtnbbs.service.ComtnbbsService;
import kosii.test.crud.comtnbbs.service.ComtnbbsVO;
...
public class ComtnbbsController {
	 ...
	 * 
	 * @param searchVO
	 *            - 조회할 정보가 담긴 ComtnbbsDefaultVO
	 * @return "kosii/test/crud/comtnbbs/ComtnbbsList"
	 * @exception Exception
	 */
	@RequestMapping(value = "/comtnbbs/ComtnbbsList.do")
	public String selectComtnbbsList(
			@ModelAttribute("searchVO") ComtnbbsDefaultVO searchVO,
	...
	public String addComtnbbsView(
		...
		return "kosii/test/crud/comtnbbs/ComtnbbsRegister";
	}

	@RequestMapping("/comtnbbs/addComtnbbs.do")
	public String addComtnbbs(ComtnbbsVO comtnbbsVO,
			@ModelAttribute("searchVO") ComtnbbsDefaultVO searchVO,
	...
	public @ModelAttribute("comtnbbsVO") ComtnbbsVO selectComtnbbs(
	...
	public String updateComtnbbs(ComtnbbsVO comtnbbsVO,
			@ModelAttribute("searchVO") ComtnbbsDefaultVO searchVO,
			SessionStatus status) throws Exception {
	...
	public String deleteComtnbbs(ComtnbbsVO comtnbbsVO,
			@ModelAttribute("searchVO") ComtnbbsDefaultVO searchVO,
			SessionStatus status) throws Exception {
